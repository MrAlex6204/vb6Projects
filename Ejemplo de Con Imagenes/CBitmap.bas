...
Public Function MostrarPNG(Pct As PictureBox, PathImagen As String)
    
    Dim pngClass As New ModLoadPNG
    
    Pct.Picture = LoadPicture("")
    With pngClass
        .PicBox = Pct
        .SetToBkgrnd False, 0, 0
        .BackgroundPicture = Pct
        .SetAlpha = True
        .SetTrans = True
    End With
    pngClass.OpenPNG PathImagen
    Set pngClass = Nothing
End Function
