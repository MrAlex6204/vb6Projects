...
With GloboPropiedadaes
        ...
        .Icono = MDIForm1.Icon
        .Info = "Base De Datos System" & vbNullChar 'Muestra Informacion Rapida
...
With GloboPropiedadaes
        ...
        .IconStyle = TipoAlerta Or SinIcono Or TipoMensaje Or Icono
        .Evento = WM_LBUTTONDBLCLK 'constante declarada que define como se oculta el Globo
        .Icono = MDIForm1.Icon 'Muestra el icono del form en  la barra de tareas
        ...
        .Titulo = "Base De Datos System" & Chr(0) 'Titulo del globo
...
Shell_NotifyIcon NIM_DELETE, GloboPropiedadaes
