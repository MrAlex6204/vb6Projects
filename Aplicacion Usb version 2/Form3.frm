...
Private Sub dirPrueba_Click()

Text1.Text = dirPrueba.Path
End Sub

Private Sub dirPrueba_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
