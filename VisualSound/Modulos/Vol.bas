...
'---------------------------------------------------------------------------------------
' Module    : Vol
' DateTime  : 30/09/2007 21:42
' Author    : elGuille
' Purpose   : http://www.recursosvisualbasic.com.ar/htm/listado-api/224-modificar-volumen-de-la-tarjeta-de-sonido.htm
'---------------------------------------------------------------------------------------
...
Public Sub SiempreVisible(Frm As Form, Check As Boolean)
If Check = True Then
